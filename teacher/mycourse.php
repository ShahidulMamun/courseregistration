            ...
            <?php
             ...
             ?>
              ...
              <?php
                ...
                $query="SELECT * FROM courseenrolls WHERE courseTeacher='$courseTeacher'";
 ...
 ?>
            ...
            <?php  }
                ...
                <?php if ($courseEnrolldata['status']==1) {?>
                     ...
                     <button type="button" class="btn btn-warning" disabled=""> &nbsp; Not Approved Yet!
                   </button>
                </a>
               ...
               <?php   
                ...
                <button type="button" class="btn btn-info" disabled=""> </i> &nbsp; Ongoing
                   </button>
                </a>
                ...
                <?php } ?>
                  ...
                  <button type="button" class="btn btn-info" disabled=""> &nbsp; Paid
                   </button>
                ...
                <?php       } } ?>
                  ...
                  <a href="?del_course=<?php echo $courseEnrolldata['id']?>&&usr=<?php echo $usr?>"><button type="button" class="btn btn-danger"> &nbsp; Reject
                   ...
                   <?php   }elseif($courseEnrolldata['status']==2 AND $courseEnrolldata['payment_status']==0 ){?>
                      ...
                      <a onclick ="return confirm('Sorry! Payment is not paid yet! after making payment you can complet this course!')"href=""><button type="button" class="btn btn-info">Clicke to complete course</button></a>
             

                   <?php }elseif($courseEnrolldata['status']==2 AND $courseEnrolldata['payment_status']==1 ){?>
                       
                        <a href="?completed_course=<?php echo $courseEnrolldata['id']?>&&usr=<?php echo $usr?>"><button type="button" class="btn btn-info">&nbsp; Clicke to complete course</button>
