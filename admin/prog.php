...
<?php
          ...
          if($_SERVER["REQUEST_METHOD"] == "POST"){
           ...
           if($program_code=="" || $department_id=="") {


              $error= "<span style=color:#ffff;>"." Sorry! One or More Field are Missing!.</span>";
            
            }else{  
                   $checkquery  ="SELECT * FROM programs WHERE program_code= '$program_code' AND department_id='$department_id'";
                   $checkresult = $db->select($checkquery);
                   if ($checkresult!=false){
                     $error="This Programme already Recorded!";
                 
                   }else{
               
                  $query ="INSERT INTO programs(program_code,department_id) VALUES('$program_code','$department_id')";
            ...
            <div class="modal-dialog">
              <div class="modal-content bg-info">
                <div class="modal-header">
                  <h4 class="modal-title">Programme Information</h4>
                ...
                <div class="card-body">
                 ...
                 <?php  while ($result = $deptdata->fetch_assoc()) { ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="program_code" name="program_code" placeholder="Programme Code">
                  </div>
            ...
            <?php   
             ...
             { ?>
                ...
                <tr>
                    ...
                    <td><?php echo $programdata['program_Id']?></td>
                    <td><?php echo $programdata['program_code']?></td>
                    <td><?php 
                ...
                <?php }?>
                 ...
                 <?php }else{ ?>
                    <button type="button" class="btn btn-info"> </i> &nbsp; Sorry! Programs Not Found!
