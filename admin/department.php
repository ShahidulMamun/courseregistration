...
<?php
          ...
          $dept_name        = $_POST['dept_name'];
           ...
           if($dept_name=="") {
              ...
              $error= "<span style=color:#ffff;>"." Department Name Must Not Empty.</span>";
            
            }else{  
                   $checkquery  ="SELECT * FROM departments WHERE dept_name= '$dept_name'";
                   $checkresult = $db->select($checkquery);
                   if ($checkresult!=false){
                     $error="This Department already Recorded!";
            ...
            <?php   
             ...
             { ?>
                ...
                <tr>
                    ...
                    <td><?php echo $departmentdata['id']?></td>
                   <td><?php echo $departmentdata['dept_name']?></td>
                <!-- <td style="text-align: center;"> 
                  <a href="add_course.php?course_dept=<?php echo $departmentdata['dept_name']?>&&dept_id=<?php echo $departmentdata['id']?>"><button type="button" class="btn btn-info">
                ...
                <?php }?>
                 ...
                 <?php }else{ ?>
                    <button type="button" class="btn btn-info"> </i> &nbsp; Sorry! Department Not Found!
