...
<?php
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          $DataProvider      = $_POST['DataProvider'];

           if($transactionid=="" || $DataProvider== "") {
              $error= "<span style=color:#ffff;>"."TransactionID or Provider Field missing.</span>";
            
            }else{  
                   $checkquery  ="SELECT * FROM transactionid WHERE trnxID= '$transactionid'";
                   $checkresult = $db->select($checkquery);
                   if ($checkresult!=false){
                     $error="TransactionID Already Used!";
                 
                   }else{
                  $query ="INSERT INTO transactionid(trnxID,trnxIdProvider) VALUES('$transactionid','$DataProvider')";
                  $insert_userdata = $db->insert($query);

                  $msg ="TransactionID Added!";
      ...
      <div class="container-fluid">
          ...
          <div class="modal fade" id="modal-info">
              ...
              <form role="form" action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="transactionid" name="transactionid" placeholder="TransactionID">
                  </div>

                    <div class="form-group">
                    <label for="Data Provider">Data Provider</label>
                  <select name="DataProvider" id="DataProvider" required="" class="form-control">
            ...
            <?php   
              ...
              while ($trnxdata = $trnx->fetch_assoc()) 
                           
             { ?>
             
                <tr>

                    <td><?php echo $trnxdata['id']?></td>
                    <td><?php echo $trnxdata['trnxID']?></td>
                    <td><?php echo $trnxdata['trnxIdProvider']?></td>
                    <td><?php if ( $trnxdata['status']==1) {
                       echo "Active";
                    }elseif( $trnxdata['status']==2){
                       echo "Used";
                    } ?></td>
